...
const Navbar = () => {
  ...
  return (
    <div className='flex items-center justify-between py-5 font-medium'>
        <Link to='/'><img src={assets.logo} alt='logo' className='w-32 h-18' /></Link>
        ...
        <div className='flex items-center gap-6'>
            ...
            <img onClick={()=>setVisible(true)} src={assets.menu_icon} alt='' className='w-5 cursor-poiter sm:hidden' />    
        </div>
